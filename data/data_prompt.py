...
class RationalePromptTemplate(BasePromptTemplate):
    ...
    def get_string(self, query=None, gold=None, text=None, task_specific_instruction=None, messages=None, **params):
        ...
        input_params = {"query": query, "gold": gold, "text": text, "task_specific_instruction": task_specific_instruction}
...
class CritiqueRationalePromptTemplate(BasePromptTemplate):
    ...
    def get_string(self, query=None, gold=None, text=None, rationale=None, task_specific_instruction=None, messages=None, **params):
        if messages is not None:
            if isinstance(messages, str):
                return self.truncate_prompt(messages)
            if self.is_chat and self.enable_chat:
        ...
        input_params = {"query": query, "gold": gold, "text": text, "rationale": rationale, "task_specific_instruction": task_specific_instruction}
        input_params.update(**params)
